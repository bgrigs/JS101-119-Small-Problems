...
function isReserved(name) {
  // forEach does not consider its return value. using some instead as it returns a boolean value. can also use includes
  return RESERVED_KEYWORDS.some(reserved => name === reserved) || false;
}
