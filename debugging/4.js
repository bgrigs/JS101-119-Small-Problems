...
function completeTasks(n = 1) {
  ...
  while (todos.length > 0 && tasksComplete < n) {
    ...
    todos.shift(); // replaced delete todos[0];
    tasksComplete++;
    console.log(todos);
  }
...
The Array.prototype.shift() method provides the behavior appropriate for our code. It removes the first element of an array, shifts the values at consecutive indexes down, and updates the length of the array.
