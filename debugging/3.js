...
let dish = [random(ingredients, 3), random(spices, 2), random(extras, 1)].flat();
...
console.log('How about: ' + dishName.join(' ')); // join on both of these lines was previously being called on a string instead of an array
