...
/*
Input: a number (representing an inventory ID) and an array. Each element in the array is an object.
Output: an array containing only the transactions for the invetory item (aka it will be an array in which all of the elements are objects)

Algo:
 -- IF transactions[id] === idNumber, push element to new array
*/
